...
export default function HomePage() {
  return (
    <div className="w-full bg-white">
      {/* 1. HERO */}
      <section className="relative pt-10 pb-10 md:pt-16 md:pb-16 overflow-hidden bg-white">
        <div className="page-container grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          {/* Hero Left Content */}
          <div className="w-full flex flex-col items-start gap-8">
            <span className="text-xs font-black tracking-widest text-blue-bright uppercase block">
              DIGITAL GROWTH PARTNER FOR BUSINESSES
            </span>
            <h1 className="text-5xl md:text-[72px] font-black tracking-tight text-navy leading-[1.02]">
              Build better.<br />
              Grow smarter.<br />
              Scale with<br />
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-xs font-bold text-grey mt-6 select-none">
              <span>Website</span>
              <span className="w-1.5 h-1.5 bg-blue-bright rounded-sm"></span>
              <span>Marketing</span>
              <span className="w-1.5 h-1.5 bg-blue-bright rounded-sm"></span>
              <span>CRM</span>
              <span className="w-1.5 h-1.5 bg-blue-bright rounded-sm"></span>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="page-container grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="w-full flex justify-center">
            <div className="relative w-full max-w-[500px] h-[320px] flex items-center justify-between px-8 bg-white border border-border rounded-2xl py-8 shadow-[0_1px_3px_rgba(10,25,49,0.04)]">
              {/* Left side: Tangled network */}
              <div className="relative w-[190px] h-[190px]">
                {/* Google */}
                <div className="absolute top-[24px] left-[10px] w-8 h-8 rounded-full bg-white border border-border flex items-center justify-center shadow-sm z-20">
                ...
                {/* FB */}
                <div className="absolute bottom-[24px] left-[10px] w-8 h-8 rounded-full bg-white border border-border flex items-center justify-center shadow-sm z-20">
                ...
                {/* Insta */}
                <div className="absolute top-[2px] left-[78px] -translate-x-1/2 w-8 h-8 rounded-full bg-white border border-border flex items-center justify-center shadow-sm z-20">
                ...
                {/* WhatsApp */}
                <div className="absolute top-1/2 -translate-y-1/2 right-[10px] w-8 h-8 rounded-full bg-white border border-border flex items-center justify-center shadow-sm z-20">
                ...
                {/* Mail */}
                <div className="absolute bottom-[6px] left-[110px] w-8 h-8 rounded-full bg-white border border-border flex items-center justify-center shadow-sm z-20">
                ...
                <svg className="absolute inset-0 w-full h-full pointer-events-none z-10" viewBox="0 0 180 180">
                  <line x1="26" y1="40" x2="90" y2="90" stroke="#E2E8F0" strokeWidth="1.2" />
                  <line x1="26" y1="140" x2="90" y2="90" stroke="#E2E8F0" strokeWidth="1.2" />
                  <line x1="78" y1="18" x2="90" y2="90" stroke="#E2E8F0" strokeWidth="1.2" />
                  <line x1="154" y1="90" x2="90" y2="90" stroke="#E2E8F0" strokeWidth="1.2" />
                  <line x1="126" y1="158" x2="90" y2="90" stroke="#E2E8F0" strokeWidth="1.2" />
                  <path
              ...
              <div className="w-[200px] flex flex-col items-center gap-3">
                <div className="w-full py-8 px-4 bg-white border border-border rounded-2xl flex flex-col items-center justify-center shadow-sm">
      ...
      <section className="py-16 md:py-20 bg-blue-surface border-y border-[#CCE0FF]/40">
        <div className="page-container grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          {/* Score Card preview left column */}
          <div className="w-full flex justify-center">
            <Card className="w-full max-w-[460px] border border-border shadow-sm p-7 bg-white rounded-2xl flex flex-col gap-5">
              <div className="border-b border-border pb-3">
                <span className="text-[9px] font-black text-grey uppercase tracking-widest block">Business Growth Score</span>
              </div>
                ...
                <div className="flex-1 flex flex-col gap-3 w-full">
                  <div className="flex flex-col gap-1.5 w-full">
                    ...
                    <div className="w-full h-2 bg-[#E2E8F0] rounded-full overflow-hidden">
                      <div className="bg-blue-bright h-full rounded-full w-[78%]" />
                    </div>
                  </div>
                  <div className="flex flex-col gap-1.5 w-full">
                    <div className="flex justify-between text-[11px] font-bold text-grey">
                    ...
                    <div className="w-full h-2 bg-[#E2E8F0] rounded-full overflow-hidden">
                      <div className="bg-blue-bright h-full rounded-full w-[72%]" />
                    </div>
                  </div>
                  <div className="flex flex-col gap-1.5 w-full">
                    <div className="flex justify-between text-[11px] font-bold text-grey">
                    ...
                    <div className="w-full h-2 bg-[#E2E8F0] rounded-full overflow-hidden">
                      <div className="bg-[#F59E0B] h-full rounded-full w-[55%]" />
                    </div>
                  </div>
                  <div className="flex flex-col gap-1.5 w-full">
                    <div className="flex justify-between text-[11px] font-bold text-grey">
                    ...
                    <div className="w-full h-2 bg-[#E2E8F0] rounded-full overflow-hidden">
                      <div className="bg-red h-full rounded-full w-[48%]" />
                    </div>
                  </div>
                  <div className="flex flex-col gap-1.5 w-full">
                    <div className="flex justify-between text-[11px] font-bold text-grey">
                    ...
                    <div className="w-full h-2 bg-[#E2E8F0] rounded-full overflow-hidden">
                      <div className="bg-blue-bright h-full rounded-full w-[66%]" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2 border-t border-border">
                <span className="text-[9px] font-bold text-grey uppercase tracking-wider">Key:</span>
                <span className="flex items-center gap-1 text-[9px] font-bold text-[#475569]">
          ...
          <div className="w-full flex flex-col items-start gap-8">
            ...
            <div className="flex flex-col items-start gap-4 w-full mt-2">
              ...
              <div className="flex items-center gap-x-2 gap-y-1 text-xs font-bold text-grey mt-1 select-none">
      ...
      {/* 6. INDUSTRIES */}
      <section className="py-16 md:py-20 bg-white border-t border-border" id="industries">
        <div className="page-container">
          ...
          <div className="flex items-center gap-4 overflow-x-auto pb-4">
            <button aria-label="Previous industries" className="w-10 h-10 rounded-full border border-border bg-white flex items-center justify-center text-grey shadow-sm hover:border-blue-bright hover:text-blue-bright transition-all flex-shrink-0">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 19l-7-7 7-7" />
              </svg>
            </button>

            <div className="flex flex-col items-center gap-3 min-w-[120px] text-center">
              <div className="w-20 h-20 rounded-full bg-blue-surface border border-[#CCE0FF]/60 flex items-center justify-center hover:border-blue-bright transition-colors shadow-sm">
                <svg className="w-7 h-7 text-blue-medium" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span className="text-sm font-bold text-navy">Auto Dealers</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-3 min-w-[120px] text-center">
              ...
              <span className="text-sm font-bold text-navy">Clinics &amp; Healthcare</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-3 min-w-[120px] text-center">
              ...
              <span className="text-sm font-bold text-navy">Restaurants &amp; Food</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-3 min-w-[120px] text-center">
              ...
              <span className="text-sm font-bold text-navy">Real Estate</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-3 min-w-[120px] text-center">
              ...
              <span className="text-sm font-bold text-navy">Retail &amp; D2C</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-3 min-w-[120px] text-center">
              ...
              <span className="text-sm font-bold text-navy">Education</span>
            </div>

            <button aria-label="Next industries" className="w-10 h-10 rounded-full border border-border bg-white flex items-center justify-center text-grey shadow-sm hover:border-blue-bright hover:text-blue-bright transition-all flex-shrink-0">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
